...
public class EnemyCase extends BoardCase {
	...
	public void interaction(Personnage player) {
		...
		while ((player.getLife()) > 0 && (enemy.getLife() > 0)) {
			...
			System.out.println("Vous attaquez le " + enemy.getName() + "joli coup ! il perd " + player.getAttack()
					+ " points de vie");
			...
			if (enemy.getLife() > 0) {
				...
				System.out.println("Oups ! l'ennemie vous fait perdre " + enemy.getAttack()
						+ " points de vie, il reste " + player.getLife() + " pv");
			}
